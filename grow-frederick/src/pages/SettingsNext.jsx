...
// TypeScript-style interfaces for better type safety
const UserProfile = {
  displayName: '',
  email: '',
  bio: '',
              ...
              <div className="settings-panel" id="panel-preferences" role="tabpanel">
                ...
                <div className="preferences-form">
                  <div className="form-group">
                    ...
                    <select
                      id="plantingZone"
                      value={preferences.plantingZone}
                      onChange={(e) => setPreferences(prev => ({ ...prev, plantingZone: e.target.value }))}
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) => setPreferences(prev => ({ ...prev, preferredUnits: e.target.value }))}
                      className="form-select"
                    >
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) => setPreferences(prev => ({ ...prev, weatherAlerts: e.target.value }))}
                      className="form-select"
                    >
                    ...
                    <div className="toggle-item">
                      ...
                      <label className="toggle-switch">
                        <input
                          ...
                          onChange={(e) => setNotifications(prev => ({ ...prev, pestAlerts: e.target.checked }))}
                        />
                    ...
                    <div className="toggle-item">
                      ...
                      <label className="toggle-switch">
                        <input
                          ...
                          onChange={(e) => setNotifications(prev => ({ ...prev, frostWarnings: e.target.checked }))}
                        />
                        <span className="slider"></span>
                      </label>
                    </div>
                    ...
                    <div className="toggle-item">
                      ...
                      <label className="toggle-switch">
                        <input
                          ...
                          onChange={(e) => setNotifications(prev => ({ ...prev, harvestReminders: e.target.checked }))}
                        />
                        <span className="slider"></span>
                      </label>
                    </div>
